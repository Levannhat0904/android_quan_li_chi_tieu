...
public class CustomBottomSheetDialog_chi_tieu_chinhsua extends BottomSheetDialog {
    ...
    private int id;
    public CustomBottomSheetDialog_chi_tieu_chinhsua(Context context,int id) {
        super(context);
        this.id = id;
