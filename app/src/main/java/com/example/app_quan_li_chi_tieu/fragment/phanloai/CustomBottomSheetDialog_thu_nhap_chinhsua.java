...
public class CustomBottomSheetDialog_thu_nhap_chinhsua extends BottomSheetDialog {
    ...
    private int id;
    public CustomBottomSheetDialog_thu_nhap_chinhsua(Context context, int id) {
        super(context);
        this.id = id;
...
//                edt_loai.setText(resID_img + "");
                ...
                System.out.println("resID_img: " + resID_img);
                System.out.println("id: " + edt_loai.getText().toString());
//                dbHelper.updateData(id, edt_loai.getText().toString(), type, resID_img);
